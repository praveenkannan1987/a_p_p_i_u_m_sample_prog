...
public class GridExecution_grid {
	...
	RemoteWebDriver driver = null;
	 ...
	 public void setUp(String port, String device, String version) throws MalformedURLException {		
		...
		//capabilities.setCapability("deviceName", devi);
		//capabilities.setCapability("platformVersion", version);
		//capabilities.setCapability("platformName", "ANDROID");
		//capabilities.setCapability("browserName", "chrome");
		driver = new AndroidDriver<WebElement>(new URL("http://192.168.1.7:4444/wd/hub"), capabilities);
